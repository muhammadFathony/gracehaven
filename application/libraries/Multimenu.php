...
class Multimenu
{
	...
	{	    
	    ...
	    foreach ($items as $item)
	    {
	        ...
	        {
		        $_label = $item[$this->menu_label];
		        $label = $this->span_label == true ? "<span>{$_label}</span>" : $_label;
...
/* End of file Multimenu.php */
/* Location: ./application/libraries/Multimenu.php */
